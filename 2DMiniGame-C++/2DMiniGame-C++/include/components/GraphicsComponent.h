...
public:
	...
	/*Override Component class getID*/
	virtual ComponentID getID() const override { return ComponentID::GRAPHICS; } //All subclasses inherit automatically, there is no need to write it again in the subclass.
